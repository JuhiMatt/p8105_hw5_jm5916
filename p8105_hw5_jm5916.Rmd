...
```{r birth_sim, fig.height = 6, fig.width = 10}
#Simulation
...
### Power Plot
```{r null_plot, fig.height = 6, fig.width = 8}
...
### Estimate Plot
```{r est_plot, fig.height = 6, fig.width = 8}
...
Estimated proportion of unsolved homicides in Baltimore, MD = 0.65 (95% CI: 0.63, 0.66)
...
#### Plot
```{r murder_plot, fig.height = 11, fig.width = 8}
city_prop %>% 
  arrange(estimate) %>% 
